...
\begin{align*}
\code{SDC}(\ket{00}) \rightarrow \code{BOB}(\frac{1}{\sqrt{2}}(\ket{00}+\ket{11})) \\
\end{align*}
\begin{align*}
...
Para $i != 0 y j != 0$, tenemos que $Proj_{ij} \,\ket{00} \rightarrow*\, 0$
...
\begin{align*}
&\xrightarrow{Projeccion}* \,BIT(0,0) \,. \,1 \\ 
&\xrightarrow{Projeccion}* \,BIT(0,0) \,= inl() \times inl()    
\end{align*}
